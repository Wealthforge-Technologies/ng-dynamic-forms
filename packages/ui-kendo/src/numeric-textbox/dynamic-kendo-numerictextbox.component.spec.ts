...
import { DynamicFormsCoreModule, DynamicFormService, DynamicInputModel } from "@wf-dynamic-forms/core";
...
describe("DynamicKendoNumericTextBoxComponent test suite", () => {
    ...
    beforeEach(inject([DynamicFormService], (service: DynamicFormService) => {
        ...
        testElement = debugElement.query(By.css(`kendo-numerictextbox[id="${testModel.id}"]`));
    }));
    ...
    it("should initialize correctly", () => {
        ...
        expect(component.kendoNumericTextBox instanceof NumericTextBoxComponent).toBe(true);
