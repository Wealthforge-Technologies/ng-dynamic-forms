...
import { DynamicFormsCoreModule, DynamicFormService, DynamicSelectModel } from "@wf-dynamic-forms/core";
...
describe("DynamicKendoDropdownListComponent test suite", () => {
    ...
    let testModel = new DynamicSelectModel({id: "select", options: [{value: "One"}, {value: "Two"}], value: "One"}),
        formModel = [testModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicKendoDropdownListComponent>,
        component: DynamicKendoDropdownListComponent,
    ...
    beforeEach(inject([DynamicFormService], (service: DynamicFormService) => {
        ...
        testElement = debugElement.query(By.css(`kendo-dropdownlist[id="${testModel.id}"]`));
    }));
    ...
    it("should have an kendo-dropdownlist element", () => {
