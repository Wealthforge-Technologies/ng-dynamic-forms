...
import { DynamicCheckboxModel, DynamicFormsCoreModule, DynamicFormService } from "@wf-dynamic-forms/core";
...
describe("DynamicFoundationCheckboxComponent test suite", () => {
    ...
    let testModel = new DynamicCheckboxModel({id: "checkbox"}),
        formModel = [testModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicFoundationCheckboxComponent>,
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            ...
            declarations: [DynamicFoundationCheckboxComponent]
