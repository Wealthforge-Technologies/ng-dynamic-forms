...
import { DynamicFormsCoreModule, DynamicFormService, DynamicRadioGroupModel } from "@wf-dynamic-forms/core";
...
describe("DynamicNGBootstrapRadioGroupComponent test suite", () => {
    ...
    let testModel = new DynamicRadioGroupModel({
        ...
        formModel = [testModel],
        formGroup: FormGroup,
        fixture: ComponentFixture<DynamicNGBootstrapRadioGroupComponent>,
